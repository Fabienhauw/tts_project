...
test_con = [11]; % 11 = normal - scrambled in the auditive script; 22 = (normal + numbers + words + PW) - scr speech; %test_con = number of the contrast used to select the voxels (in SPM.mat of the select_path)
...
%     AUD "big" phonology, RH synesthetes
%                    SMG,      pSTS,        aSTS,    vis VWFA,      VWFA,         aVWFA,       iTPol,       sTPol,      sIFG,      mIFG,      iIFG.
