...
%         
        ...
        values = {...
            ...
            3*numbers-(faces+houses+words), numbers-words, words - numbers, 2*numbers-(faces+houses), ...
            EOI, ...
            };
        ...
        names = {...
            ...
            'numbers-(faces+houses+words)', 'numbers-words', 'words - numbers', '2*numbers-(faces+houses)', ...
            'EOI',...
            };
...
% cd '/network/lustre/iss02/cohen/data/Fabien_official/SYNESTHEX/scripts/launcher'
% 
% par.run = 0;
% par.sge = 1;
