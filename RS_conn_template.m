...
only_right = 1;
roi_incl = 1; %1, 2, 3 or 4 for brainnetome atlas, networks, or personnalized ROIs Aud or Vis.
modif_freq = 0;
...
%     proj_name = (sprintf('%s_brainnetome.mat', proj_name));
    proj_name = (sprintf('%s_atlas_conn.mat', proj_name));
elseif roi_incl == 2
...
%         batch.Setup.rois.names              = {'Grey Matter','White Matter','CSF','atlas_brainnet'};
        batch.Setup.rois.names              = {'Grey Matter','White Matter','CSF','atlas_conn'};
...
%             batch.Setup.rois.files{4,nses}           = '/network/lustre/iss02/cohen/data/Fabien_official/atlas/brainnetome/BN_Atlas_246_1mm_reoriented.nii';
            batch.Setup.rois.files{4,nses}           = '/network/lustre/iss02/cohen/data/Fabien_official/atlas/conn_atlas/atlas_reoriented.nii';
    ...
    case 3
        ...
        for nses = 1 : nsessions
            ...
            batch.Setup.rois.files{length(aud_coord_names)*2 + 4,nses}  = '/network/lustre/iss02/cohen/data/Fabien_official/SYNESTHEX/second_level/rs/images/gcorr/lantmfg_bin_gcorr_roi_syn>con_510-3_510-2.nii';
            batch.Setup.rois.names{length(aud_coord_names)*2 + 4}       = 'left_ant_mfg_roi_global_connect';
            batch.Setup.rois.files{length(aud_coord_names)*2 + 5,nses}  = '/network/lustre/iss02/cohen/data/Fabien_official/SYNESTHEX/second_level/rs/images/gcorr/sma_bin_gcorr_roi_syn>con_510-3_510-2.nii';
